  ...
  <div class="col-lg-6">
    <div class="block">
      ...
      <div class="block-body">
        ...
        <h5 class="card-text mb-5"><?php echo esc($usuario->nome); ?></h5>
        <?php echo form_open('/', ['id' => 'form'], ['id' => "$usuario->id"]) ?>

        <?php echo $this->include('usuario/_senha'); ?>

        <div class="form-group mt-5 mb-2">
          <input id="btn-salvar" type="submit" value="Atualizar" class="btn btn-danger btn-sm mr-e">
...
<script>
  $(document).ready(function() {
    $("#form").on('submit', function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo site_url('usuarios/alterarsenha'); ?>',
